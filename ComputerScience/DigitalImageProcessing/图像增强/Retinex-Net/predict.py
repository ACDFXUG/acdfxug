...
parser.add_argument('--data_dir', dest='data_dir',
                    default='C:/Users/yaoyu/Desktop/VSCode/DigitalImageProcessing/图像增强/LOLdataset',
...
def predict(model):
    ...
    test_low_data_names  = glob(args.data_dir + '/' + '*low.*')
    test_low_data_names.sort()
    for i in range(len(test_low_data_names)):
        print(test_low_data_names[i])
