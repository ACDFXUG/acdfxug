...
def get_results(search, headers, page, stars):
    url = f'https://api.github.com/search/repositories?q={search}%20stars:"\
        "<={stars}&page={page}&per_page=100&sort=stars&order=desc'
...
if __name__ == '__main__':
    ...
    headers = {'User-Agent': 'Mozilla/5.0',
               'Authorization': 'token C:/Users/yaoyu/Desktop/github API.txt',
